...
from fromdvd.classColor.dvdColor import ColorCorp
...
class Form_BBDD(FormPosMov):
    ...
    def __init__(self, 
        ...
        AQUI HAY QUE DEFINIR QUE TIPOS DE ARCHIVO FUENTE VA A USAR EL FORMULARIO DINADB
         """
    ...
    def bttn_loadfile_click(self):      
        ...
        if self.archivo:
            ...
            ruta_abrevd = form_BBDD.ruta_abrevd(ruta_archivo)
            # print(ruta_abrevd)
