"""
Ejercicio 2: Una juguetería tiene mucho éxito en dos de sus productos: payasos y muñecas. 
...
P=112
M=75
uno=int(input("Intro payasos...."))
dos=int(input("Intro muñecas...."))

print("Peso total  = " , float(round(P*uno,2))+float(round(M*dos,2)))
