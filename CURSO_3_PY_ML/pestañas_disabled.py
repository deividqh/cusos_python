...
ventana = tk.Tk()
ventana.title("Pestañas Visibles pero Desactivadas")
...
# 4. Añadimos todas las pestañas al Notebook desde el inicio
...
# 5. BLOQUEO: Desactivamos las pestañas 2, 3 y 4 inmediatamente
