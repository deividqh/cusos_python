def ejer_1():
    """ Ejercicio 1 - Regresión Lineal Simple (Scikit-Learn)
    ...
    """ Justificación: El alumno demuestra su capacidad para instanciar, ajustar y visualizar un modelo básico de
    Scikit-learn, traduciendo una relación teórica en una representación matemática funcional """

def ejer_2():
    """ Ejercicio 2 - Regresión Lineal con Statsmodels
    ...
    pass
def ejer_3():
    """ Ejercicio 3 - Ajuste de Mínimos Cuadrados (Fundamentos)
    ...
    """ Justificación: Al implementar la lógica subyacente sin abstracciones, el alumno consolida la comprensión del
    proceso de optimización que ocurre dentro de las librerías estándar """
    pass
def ejer_4():
    """ Ejercicio 4 - Regresión Lineal Múltiple
...
def ejer_5():
    """ Ejercicio 5 - Tratamiento de Variables Categóricas en Regresión
    import pandas as pd 
    from sklearn.linear_model import LinearRegression 
    ...
    df_encoded = pd.get_dummies(df_med, columns=['Genero'], drop_first=True) 
    # 3. Entrenamiento 
    ...
    """ Justificación: Esta competencia es vital, ya que los modelos matemáticos solo aceptan números; el alumno
    demuestra que sabe preparar datos del mundo real para el análisis. """
    pass
def ejer_6():
    """ Ejercicio 6 - Regresión Polinomial
    ...
    plt.legend() 
    plt.show() 
    """ Justificación: El alumno identifica la limitación del modelo lineal y selecciona una herramienta más compleja
    para capturar la naturaleza no lineal de los fenómenos biológicos. """

def ejer_7():
    """ Ejercicio 7 - Análisis de Complejidad y Sobreajuste (Overfitting)
    ...
    plt.tight_layout() 
    plt.show() 
    """Justificación: La capacidad de discernir entre un buen ajuste y el sobreajuste es lo que diferencia a un
    especialista en IA de un usuario básico de herramientas.  """
    pass
def ejer_8():
    """ Ejercicio 8 - Regresión Logística (Introducción)
    ...
    """Justificación: El alumno entiende el cambio de paradigma de predecir un valor continuo a predecir la
    probabilidad de una categoría.  """
    pass
def ejer_9():
    """  Ejercicio 9 - Evaluación de Regresión Logística
    ...
    """ Justificación: El alumno demuestra que sabe interpretar si un modelo es útil en la práctica analizando falsos
    positivos y negativos, no solo la exactitud global """


def ejer_10():
    """ Ejercicio 10 - Creación de un Pipeline de Regresión Completo
    ...
    """ Justificación: Este ejercicio final integra todas las piezas: gestión de datos, validación cruzada y métricas de
