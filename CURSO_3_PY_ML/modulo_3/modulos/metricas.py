...
# ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
def informe_clasificación(modelo_fit, X_test, y_test, target_names):
    from sklearn.metrics import classification_report

    print(classification_report(y_test, modelo_fit.predict( X_test ), target_names = target_names))

# ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
# ■ MATRIZ DE CONFUSION
# ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
# Es el "mapa de errores" que te permite ver no solo cuántas veces falló el modelo, sino en qué se está 
# confundiendo exactamente.
...
def matrix_confusion(modelo_entrenado, X_test, y_test, target_names, plt):
...
def rendimiento_score(modelo_fit, X_test, y_test):
    # mod_fit   = SVC().fit(X_train_scaled, y_train)
    mod_score = modelo_fit.score(X_test, y_test)
...
def exactitud_accuray_score(mod_fit, X_test, y_test):
...
def sensibilidad_recall(modelo_fit, X_test, y_test):
...
def precision_precision_score(modelo_fit, X_test, y_test):
