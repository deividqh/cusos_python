...
class FormPosMov():
    ...
    def posicionDescForm(self):   
        ...
        elif self.descpos=='c:e':
            """ Situa el Formulario en el UP - Derecha """

        elif self.descpos=='c:c' or self.descpos=='c' or self.descpos=='cc' :
            """ Situa el Formulario en el Centro de la pantalla"""

        elif self.descpos=='n:w':
            """ Situa el Formulario en el UP - Izquierda """

        elif self.descpos=='n:e':
            pass

        elif self.descpos=='n:c'  or self.descpos=='nc' or self.descpos=='cn' :
            """ Situa el Formulario en el Centro - Arriba """

        elif self.descpos=='s:w' :
            pass

        elif self.descpos=='s:e':
            pass

        elif self.descpos=='s:c'  or self.descpos=='sc' or self.descpos=='cs':
            """ Situa el Formulario en el Centro - Abajo"""
            pass
        pass     
